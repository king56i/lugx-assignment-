...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?=URLROOT?>/css/dangky.css">
    ...
    <link rel="stylesheet" href="<?=URLROOT?>/css/danhmuc.css">
    <link rel="stylesheet" href="<?=URLROOT?>/css/quenmkxacnhan.css">
    <link rel="stylesheet" href="<?=URLROOT?>/css/dathangdanhmuc.css">
        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                      <li><a href="<?=URLROOT?>" <?php if($data['title']=='Trang chủ') echo "class='active'"?>>Trang Chủ</a></li>
                      <li><a href="<?=URLROOT?>/pages/cuaHang" <?php if($data['title']=='Cửa Hàng') echo "class='active'"?>>Cửa hàng</a></li>
                      <li><a href="#" <?php if($data['title']=='Thông Tin') echo "class='active'"?>>Thông tin</a></li>
                      <li><a href="contact.html" <?php if($data['title']=='Liên Hệ') echo "class='active'"?>>Liên hệ</a></li>
                    ...
                    <?php }else if(isset($_SESSION['username'])){ ?>
                        <li class="nav-item active">
                            <a class="nav-link" style="background-color:transparent" aria-current="page" href="<?=URLROOT?>/admin">Quản Lý</a>
                        </li>
                    <?php } ?>  
                  </ul>   
